...
**Do not** open public GitHub issues for unembargoed vulnerabilities.
Email `security@asve.dev` instead. We acknowledge reports within 5
business days.
...
> `open-agent-security/asve`.

## V0 status

ASVE V0 documents the disclosure process. The active disclosure
